...
\input{sections/pre-proc}
\input{sections/asp}
\input{sections/expval}
\input{sections/conclusion}

\textit{Acknowledgments} \\
Questo progetto è stato realizzato durante il corso di Programmazione Dichiarativa 
(a.a. 2024--25), presso l'Università degli Studi di Parma. Tutti i benchmark sono 
stati effettuati su un chip Apple Silicon M3Pro avente 11 core e 18 GB RAM.\\
Il codice sorgente è disponibile su Github: 
\begin{center}
  \url{https://github.com/simonecolli/ottimizzazione-garanti-accademici}.
\end{center}
